...
Public Class zonchiholidays
    ...
    Public Sub New()
        ...
        zonchiholidaysConnectionString = System.Configuration.ConfigurationManager.ConnectionStrings("zonchiholidaysConnectionString").ConnectionString.ToString
    End Sub
   ...
   Public Function SavePropertyActivities( _
    ...
    <WebMethod(CacheDuration:=10)> _
        ...
        Try
            ...
            oConn.Close()
        Catch ex As Exception
            GetCountryList2.RequestedParentID = 0
            ReDim Preserve GetCountryList2.ChildLocations(0)
            GetCountryList2.ChildLocations(0).LocationDescription = ex.Message.ToString
            GetLocations = GetCountryList2
